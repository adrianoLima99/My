 ...
 */
public class ContatoConexoesAdapter extends BaseAdapter {
    private AlertDialog alerta;
    private Activity activity;
    private LayoutInflater inflater;
    private List<ContatoConexoes> movieItems;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();

    public ContatoConexoesAdapter(Activity activity, List<ContatoConexoes> movieItems) {
...
*/
        ...
        final ContatoConexoes c = movieItems.get(position);
        ...
        nome.setText(c.getNome().trim());
        numero.setText(c.getNumero());
        profissao.setText(c.getProfissao().trim());

        img_detalhes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                    Utilitaria.janelaPoupUp(activity,c.getNome().trim(),c.getProfissao().trim(),c.getNumero(),c.getEmail(),c.sobre);
                }});
